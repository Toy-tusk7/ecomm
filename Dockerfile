...
# Start WSGI Server (Gunicorn) with preloaded app context to prevent concurrent worker seeding
CMD gunicorn --preload -w 4 -b 0.0.0.0:${PORT:-10000} "app:create_app()"
